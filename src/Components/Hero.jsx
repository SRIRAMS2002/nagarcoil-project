      ...
      <div className="grid grid-cols-1 gap-0 sm:grid-cols-2 ">
        ...
        <div>
          ...
          <div className="relative   bg-black w-[19.5rem] h-[18rem] max-w-none rounded-se-[3rem]  shadow-xl ring-1 ring-gray-400/10 sm:w-[30rem] sm:h-[20rem] mt-5 md:-ml-4 lg:-ml-0">
            <h1 className="relative text-white max-w-sm mx-5 font-bold text-2xl md:leading-10 pt-8 md:text-[40px]">
              CREATING BLISSFUL PROPERTY SEARCH IS OUR SPECIALITY
            </h1>
            <p className="text-white/80 mx-5 text-sm mt-3.5 max-w-sm">
            ...
            <div>
              <div className="relative mt-2 max-w-lg  ml-5">
                ...
                <input
                  ...
                  name="price"
                  id="price"
                  className="block w-[16.5rem] sm:w-[32rem] bg-gray-200 mt-5 h-12 sm:h-16 z-10 border-0 py-1.5 pl-10 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
        ...
        <div className=" hidden sm:flex space-x-60 relative">
          <img
            src="/Hero-1.jpg"
            alt=""
            className="h-[28.1rem] w-[18rem] absolute inset-0  -left-20 -z-10"
          />
